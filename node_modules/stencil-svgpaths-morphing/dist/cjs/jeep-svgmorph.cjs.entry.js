...
const __chunk_1 = require('./chunk-d335d401.js');
...
class JeepSvgmorph {
    ...
    render() {
        if (this.isSVG) {
            return (__chunk_1.h("div", { id: "morph-container" }, __chunk_1.h("div", { id: "morph-svg-container" }, __chunk_1.h("svg", { id: "morph-svg", width: "500", height: "500", viewBox: "0 0 500 500", xmlns: "http://www.w3.org/2000/svg" }, __chunk_1.h("path", { id: "initPath" }, __chunk_1.h("animate", { id: "animPath", begin: "initPath.click" }), this._fillColor.length > 1 && !this._uniqueColor
                ? __chunk_1.h("animate", { id: "animFill", begin: "animPath.begin" })
                : null)))));
        }
        else {
            return (__chunk_1.h("div", { id: "fake-container" }));
        }
    }
